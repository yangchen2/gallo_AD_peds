...
def group_by_taxonomy_levels(biom_path: str, taxonomy_path: str, input_filter_type: str):
    ...
    taxonomy_path (str): Path to either wol2 or taxonomy reference file
...
if __name__ == '__main__':
    try:
        ...
        # logging.info("-----> Performing script with abundance filtered and Zebra filtered input.")
        # group_by_taxonomy_levels(biom_path_abundance_and_zebra, taxonomy_path, "ab_and_zebra")
